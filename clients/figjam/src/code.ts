...
const SCENE_FILL: SolidPaint = { type: "SOLID", color: { r: 0.91, g: 0.93, b: 0.96 } };
const ACTIVE_FILL: SolidPaint = { type: "SOLID", color: { r: 0.98, g: 0.98, b: 0.98 } };
const NESTED_FILL: SolidPaint = { type: "SOLID", color: { r: 0.93, g: 0.94, b: 0.96 } };
const DISABLED_FILL: SolidPaint = { type: "SOLID", color: { r: 0.88, g: 0.88, b: 0.88 } };
const COMPONENT_FILL: SolidPaint = { type: "SOLID", color: { r: 0.55, g: 0.78, b: 1.0 } };
const COMPONENT_DISABLED_FILL: SolidPaint = { type: "SOLID", color: { r: 0.74, g: 0.76, b: 0.8 } };
...
function parseHierarchyObject(
  ...
  const children = value.Children.map((child, index) =>
    parseHierarchyObject(child, expectedDepth + 1, `${path}.Children[${index}]`, counters),
  );
...
async function renderDocument(document: UniMapDocument): Promise<void> {
...
function renderHierarchyObject(
  hierarchyObject: UniMapHierarchyObject,
...
function countHierarchyNodes(nodes: UniMapHierarchyObject[]): number {
  let total = 0;
